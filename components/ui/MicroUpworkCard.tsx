...
export default function MicroUpworkCard({ className }: { className?: string }) {
    return (
        <a
            ...
            className={`micro-upwork-card group pointer-events-auto block w-fit rounded-xl bg-white px-4 py-3 transition-shadow duration-300 hover:shadow-lg${className ? ` ${className}` : ''}`}
        >
