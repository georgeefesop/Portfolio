...
export default function BackgroundToggle({ onToggle }: BackgroundToggleProps) {
    ...
    // Load saved preference - DISABLED per user request (always default to dark)
    /*
    useEffect(() => {
    ...
    */
    ...
    return (
        <motion.button
            ...
            className="absolute right-8 bottom-8 md:bottom-auto md:top-[33.33%] md:-translate-y-1/2 z-40 group scale-[0.72] md:scale-[0.8] origin-right md:origin-right"
            whileTap={{ scale: 0.95 }}
                ...
                <motion.div
                    ...
                    animate={{
                        ...
                        boxShadow: isVibrant
                            ...
                            : '0 4px 12px rgba(0, 0, 0, 0.5), inset 0 0 0 1px rgba(255,255,255,0.1)'
                    }}
