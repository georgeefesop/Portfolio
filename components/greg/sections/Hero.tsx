...
import { heroContent } from '@/data/greg/content';
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1500px] px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          {/* Copy */}
          <div>
            <p className="eyebrow mb-3">{heroContent.eyebrow}</p>
          ...
          <div className="relative">
            <BeforeAfterSlider
              beforeSrc={heroContent.beforeImage}
              afterSrc={heroContent.afterImage}
